...
//        _imgUrl = dict[@"http://7u2h3s.com2.z0.glb.qiniucdn.com/activityImg_2_0B28535F-B789-4E8B-9B5D-28DEDB728E9A"];
//    }else{
//    _imgUrl = dict[@"imgURL"];
//    }
    self = [super init];
    if(self){
    _imgUrl = [dict[@"imgUrl"] isKindOfClass:[NSNull class]]?dict[@""] : dict[@"imgUrl"];
